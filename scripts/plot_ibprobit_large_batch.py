...
def make_figure(df_dataset, dataset_name, pretrained_sources, output_dir):
...
def main():
    ...
    for dataset_name in datasets:
        ...
        make_figure(df_ds, dataset_name, pretrained_sources, args.output_dir)
