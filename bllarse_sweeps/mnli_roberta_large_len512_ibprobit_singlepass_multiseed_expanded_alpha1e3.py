...
BASE: Dict[str, Any] = dict(
    ...
    reuse_cache=True,
    enable_mlflow=True,
    group_id="mnli_roberta_large_len512_ibprobit_singlepass_multiseed_expanded_alpha1e3",
        ...
        for num_update_iters in NUM_UPDATE_ITERS:
            for seed in SEEDS:
                uid = (
                    ...
                    f"cavi_alpha1e3_bs{train_batch_size}_iters{num_update_iters}_seed{seed}_ep1"
                )
                configs.append(
                    dict(
                        **BASE,
