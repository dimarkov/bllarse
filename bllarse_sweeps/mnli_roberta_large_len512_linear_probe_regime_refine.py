...
LEARNING_RATES = [8e-4, 1e-3, 1.2e-3]
DROPOUT_RATES = [0.0, 0.02]
...
BASE: Dict[str, Any] = dict(
    ...
    reuse_cache=True,
    enable_mlflow=True,
    group_id="mnli_roberta_large_len512_linear_probe_regime_refine",
        ...
        for learning_rate in LEARNING_RATES:
            for dropout_rate in DROPOUT_RATES:
                uid = (
                    ...
                    f"_drop{dropout_rate:.2f}_seed2022_ep140"
                )
                configs.append(
                    dict(
                        **BASE,
