...
def test_roberta_large_len512_ibprobit_data_efficiency_iters6_alpha1e2_sweep_config():
    repo_root = Path(__file__).resolve().parents[2]
    sweep_path = (
        repo_root
        / "bllarse_sweeps"
        / "mnli_roberta_large_len512_ibprobit_data_efficiency_iters6_alpha1e2.py"
    )
    sweep = _load_module(sweep_path)
...
def test_roberta_large_len512_ibprobit_data_efficiency_iters6_alpha1e3_sweep_config():
    repo_root = Path(__file__).resolve().parents[2]
    sweep_path = (
        repo_root
        / "bllarse_sweeps"
        / "mnli_roberta_large_len512_ibprobit_data_efficiency_iters6_alpha1e3.py"
    )
    sweep = _load_module(sweep_path)
